...
const blogPosts = [
  ...
  {
    id: 3,
    title: "Building Secure AI Systems for Defense Applications",
    excerpt: "A deep dive into the security considerations and best practices for deploying AI in mission-critical defense environments.",
    category: "Security",
