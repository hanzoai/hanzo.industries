          ...
          <div className="max-w-5xl mx-auto">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className={cn("mt-1", isDarkMode ? "text-white/50" : "text-black/50")}>
                      {allOperational
                ...
                <div className="flex items-center gap-4">
                  <Button
                    ...
                    className={cn(isDarkMode ? "text-white/50 hover:text-white" : "text-black/50 hover:text-black")}
                  >
                    <RefreshCw className={cn("w-4 h-4 mr-2", isRefreshing ? "animate-spin" : "")} />
                    Refresh
                  </Button>
                  <div className={cn("flex items-center gap-2 text-sm", isDarkMode ? "text-white/50" : "text-black/50")}>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center", isDarkMode ? "bg-white/10" : "bg-black/5")}>
                            <Icon className={cn("w-5 h-5", isDarkMode ? "text-white/50" : "text-black/50")} />
                          </div>
                          <div>
                            <div className="flex items-center gap-2">
                              ...
                              {service.url && (
                                <a
                                  ...
                                  className={cn(isDarkMode ? "text-white/40 hover:text-white/70" : "text-black/40 hover:text-black/70")}
                                >
                                  <ExternalLink className="w-3 h-3" />
                                </a>
                              )}
                            </div>
                            <p className={cn("text-sm", isDarkMode ? "text-white/40" : "text-black/40")}>{service.description}</p>
                          </div>
                        </div>
            ...
            >
              ...
              <div className={cn(
                ...
                <div className={cn("flex justify-between mt-3 text-xs", isDarkMode ? "text-white/40" : "text-black/40")}>
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <p className={cn("text-sm", isDarkMode ? "text-white/50" : "text-black/50")}>{incident.description}</p>
                      </div>
                      <div className="text-right text-sm">
                        <div className={cn(isDarkMode ? "text-white/50" : "text-black/50")}>{incident.date}</div>
                        <div className={cn(isDarkMode ? "text-white/40" : "text-black/40")}>{incident.duration}</div>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            <motion.div
              ...
              className={cn("mt-12 text-center py-12 border-t", isDarkMode ? "border-white/10" : "border-black/10")}
            >
              <h2 className="text-2xl font-bold mb-3">
                Get Status Updates
              </h2>
              <p className={cn("mb-6 max-w-md mx-auto", isDarkMode ? "text-white/50" : "text-black/50")}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="https://twitter.com/hanaborobyai" target="_blank" rel="noopener noreferrer">
                  <Button variant="outline" className={cn(isDarkMode ? "border-white/10 hover:bg-white/10" : "border-black/10 hover:bg-black/10")}>
                    Follow @hanzoai
                  </Button>
                </a>
