  ...
  foundation: {
    ...
    models: [
      ...
      },
      {
        name: "zen-max",
        params: "671B (MoE)",
        description: "Frontier MoE — 14B active params, 256K context, 71.3% SWE-bench. Based on Kimi K2",
    ...
    models: [
      {
        name: "zen4-mini",
        params: "4B",
        description: "Compact Zen 4 for edge deployment with full-gen reasoning",
      ...
      },
      {
        name: "zen4",
        params: "8B",
        description: "Latest-gen small model with massive reasoning improvements over Zen 3",
        performance: "24K tokens/sec",
        memory: "8–16GB",
        capabilities: ["Text", "Code", "Math", "Reasoning"],
        href: "https://huggingface.co/zenlm/zen4-8b",
      },
      {
        name: "zen4-pro",
        params: "14B",
        description: "Production workhorse with strong reasoning and tool use",
        performance: "14K tokens/sec",
        memory: "16–32GB",
      ...
      },
      {
        name: "zen4-pro-max",
        params: "80B (MoE)",
        description: "Consumer flagship — hybrid Gated DeltaNet + MoE, 256K context",
        performance: "Cluster / high-end GPU",
        memory: "64–160GB",
        capabilities: ["Text", "Code", "Reasoning", "Long Context"],
        href: "https://huggingface.co/zenlm/zen4-pro-max",
      },
      {
        name: "zen4-ultra",
        params: "1.04T (MoE)",
        description: "Trillion-parameter thinking model — Kimi K2.5 base, 256K context, multimodal",
        performance: "Cloud only",
        memory: "Cloud API",
        capabilities: ["Text", "Vision", "Reasoning", "Frontier"],
    ...
    models: [
      {
        name: "zen-coder",
        params: "7B–32B",
        description: "Full-featured code generation and software engineering assistant",
      ...
      },
      {
        ...
        description: "Flagship coder — 59.2% SWE-bench (2.7x Qwen3-30B), 131K context. GLM-4.7-Flash base",
        performance: "Real-time",
        memory: "8–16GB",
        capabilities: ["Code", "Agents", "SWE-bench", "Fast"],
        href: "https://huggingface.co/zenlm/zen-coder-flash",
      },
      {
        name: "zen4-coder",
        params: "80B (MoE)",
        description: "Professional code model with agentic coding and extended tool use",
        performance: "Cluster / high-end GPU",
        memory: "64–160GB",
      ...
      },
      {
        name: "zen4-coder-pro",
        params: "355B (dense)",
        description: "Maximum code capability — dense architecture for deep reasoning",
        performance: "Cluster inference",
        memory: "Multi-node",
        capabilities: ["Code", "Research", "Deep Reasoning"],
