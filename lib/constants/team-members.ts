...
export const teamMembers = {
  ...
  dev: {
    ...
    mainIcon: Code2,
    features: [
      { icon: Code2, color: "text-blue-400", title: "Full-Stack Development", description: "Writes production code across frontend, backend, and infrastructure." },
      { icon: Bot, color: "text-cyan-400", title: "Code Review & Refactoring", description: "Reviews PRs, identifies issues, and refactors for maintainability." },
      { icon: Binary, color: "text-blue-400", title: "Architecture & Design", description: "Designs system architecture and makes technical decisions." }
    ]
  },
  opera: {
    name: "Opera",
    ...
    mainIcon: Settings,
    features: [
      { icon: Settings, color: "text-yellow-400", title: "CI/CD & Deployment", description: "Automates build pipelines, deployments, and rollbacks." },
      { icon: Rocket, color: "text-orange-400", title: "Cloud Infrastructure", description: "Manages Kubernetes, containers, and cloud resources." },
      { icon: ChartBar, color: "text-yellow-400", title: "Monitoring & Incidents", description: "Monitors system health and responds to incidents automatically." }
    ]
  },
  kira: {
    name: "Kira",
    ...
    mainIcon: Shield,
    features: [
      { icon: Shield, color: "text-red-400", title: "Threat Detection", description: "Scans for vulnerabilities and monitors for security threats." },
      { icon: Scale, color: "text-orange-400", title: "Compliance Automation", description: "Enforces security policies and generates audit reports." },
      { icon: Settings, color: "text-red-400", title: "Zero-Trust Operations", description: "Implements and maintains zero-trust security architecture." }
    ]
  },
  dax: {
    name: "Dax",
    ...
    mainIcon: Database,
    features: [
      { icon: Database, color: "text-blue-400", title: "Data Pipelines", description: "Builds and maintains ETL pipelines and data infrastructure." },
      { icon: ChartBar, color: "text-indigo-400", title: "Analytics & ML", description: "Runs analysis, builds models, and generates insights." },
      { icon: Brain, color: "text-blue-400", title: "AI/ML Operations", description: "Manages model training, evaluation, and deployment pipelines." }
    ]
  },
  ...
  desi: {
    ...
    mainIcon: Paintbrush,
    features: [
      { icon: Paintbrush, color: "text-purple-400", title: "UI/UX Design", description: "Creates intuitive interfaces and seamless user experiences." },
      { icon: Bot, color: "text-pink-400", title: "Design Systems", description: "Builds and maintains consistent component libraries and brand guidelines." },
  ...
  mana: {
    ...
    mainIcon: Briefcase,
    features: [
      { icon: Briefcase, color: "text-indigo-400", title: "Roadmap & Strategy", description: "Defines product vision, roadmap, and feature priorities." },
      { icon: FileText, color: "text-violet-400", title: "Specs & Requirements", description: "Writes detailed specifications and acceptance criteria." },
  ...
  mark: {
    ...
    mainIcon: Megaphone,
    features: [
      { icon: Megaphone, color: "text-green-400", title: "Campaigns & Content", description: "Creates and executes multi-channel marketing campaigns." },
      { icon: ChartBar, color: "text-emerald-400", title: "SEO & Analytics", description: "Optimizes search rankings and tracks conversion metrics." },
      { icon: MessagesSquare, color: "text-green-400", title: "Social & Community", description: "Manages social presence and community engagement." }
    ]
  },
  sal: {
    name: "Sal",
    ...
    mainIcon: DollarSign,
    features: [
      { icon: DollarSign, color: "text-emerald-400", title: "Pipeline & Outreach", description: "Qualifies leads, runs sequences, and manages deal flow." },
      { icon: Users, color: "text-green-400", title: "Demos & Proposals", description: "Delivers product demos and generates custom proposals." },
  ...
  su: {
    ...
    mainIcon: HelpCircle,
    features: [
      { icon: HelpCircle, color: "text-pink-400", title: "Ticket Resolution", description: "Triages and resolves support tickets across all channels." },
      { icon: Users, color: "text-rose-400", title: "Onboarding & Success", description: "Guides new users through setup and drives adoption." },
  ...
  fin: {
    ...
    mainIcon: DollarSign,
    features: [
      { icon: DollarSign, color: "text-green-400", title: "Billing & Invoicing", description: "Manages billing cycles, invoices, and payment processing." },
      { icon: ChartBar, color: "text-teal-400", title: "Forecasting & Reporting", description: "Builds financial models and generates executive reports." },
      { icon: Settings, color: "text-green-400", title: "Cost Optimization", description: "Identifies savings and optimizes operational costs." }
    ]
  },
  le: {
    name: "Le",
  ...
  vi: {
    ...
    mainIcon: Brain,
    features: [
      { icon: Brain, color: "text-gray-400", title: "Strategic Planning", description: "Defines goals, OKRs, and quarterly planning cycles." },
      { icon: Users, color: "text-slate-400", title: "Cross-Functional Coordination", description: "Aligns all departments and resolves blockers." },
      { icon: Rocket, color: "text-gray-400", title: "Executive Decisions", description: "Synthesizes data and makes high-stakes operational calls." }
    ]
  },
};
